...
namespace SampleNavigation
{
	...
	partial class Shell
	{
		...
		/// </remarks>
		public Shell(IntPtr javaReference, global::Android.Runtime.JniHandleOwnership transfer) : base (javaReference, transfer) { }
#endif
		...
		/// objects that may have been collected in the managed world.
		/// </remarks>
		public Shell(IntPtr handle) : base (handle) { }
		/// <summary>
		/// Native constructor, do not use explicitly.
		/// </summary>
		/// <remarks>
		...
		/// objects that may have been collected in the managed world.
		/// </remarks>
		public Shell(global::ObjCRuntime.NativeHandle handle) : base (handle) { }
#endif
	}
}

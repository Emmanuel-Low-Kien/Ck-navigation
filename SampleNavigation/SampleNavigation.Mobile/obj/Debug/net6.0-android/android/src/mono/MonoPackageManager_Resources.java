...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "SampleNavigation.Mobile.dll" comes first in this list. */
		"SampleNavigation.Mobile.dll",
		...
		"Chinook.DynamicMvvm.Abstractions.dll",
		"Chinook.DynamicMvvm.dll",
		"Chinook.DynamicMvvm.Uno.WinUI.dll",
		"Chinook.SectionsNavigation.Abstractions.dll",
		"Chinook.SectionsNavigation.dll",
		"Chinook.SectionsNavigation.Uno.WinUI.dll",
		"Chinook.StackNavigation.Abstractions.dll",
		"Chinook.StackNavigation.dll",
		"Chinook.StackNavigation.Uno.WinUI.dll",
		"SampleNavigation.dll",
	};
